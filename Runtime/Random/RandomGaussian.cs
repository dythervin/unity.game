...
namespace Dythervin.Game.Random
{
    ...
    {
        public static float GetRange(float minValue, float maxValue)
        {
        ...
        public static float GaussianRange(this System.Random random, float minValue, float maxValue)
        {
            return Gaussian(random, (maxValue + minValue) / 2, math.abs(maxValue - minValue));
        }

        public static float Gaussian(this System.Random random, float mean = 0.5f, float range = 0.5f)
        {
            float u, s;
